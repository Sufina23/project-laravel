...
<body>
    ...
    <div class="container justify-content-center align-content-center">
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link" aria-current="page" href="{{ route('admin.inber') }}">Input Berita</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.inda') }}">Input Data Profile Lulusan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Input Aktivitas</a>
            </li>
        </ul>
    </div>
        ...
        <tbody class="table-group-divider">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-outline-danger" href="/deleteAdmin/{{ $userAdmin->id }}">Hapus</a>
                </td>
            </tr>
            @endforeach
        </tbody>
